...
--keystore-entry-password=123456789 --keystore-password=123456789 --signer=chrispsz --keystore-entry-alias=chrispsz $patcher_args"
...
build_rv() {
        ...
        local tried_dl=()
        for dl_p in apkmirror uptodown; do
